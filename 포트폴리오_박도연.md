...
현재는 item embedding의 의미적 구조를 Graph로 분석해 Adaptive한 Item Identifier를 구성하고, 사용자 행동 정보를 Generation 과정에 활용하는 방법을 다루고 있습니다. GID(Graph-based Identifier)와 CCD(Collaborative Constrained Decoding)의 아이디어를 검증하기 위해 다양한 조건과 Case에 대한 실험을 수행하며 모델의 성능과 특성을 분석하고 있습니다.
